...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 200; i++) {
    ...
    // The random number, with a simple math applied, is passed on to generate the random initial position of the next pizza.
    r = r*(1+i);
    // Random initial position of a pizza is generated.
    var initialPhase = r%freq;

    elem.style.left = col_width*(i%cols) + oslist[initialPhase] + 'px';
